...
pub fn write_docx<W: Write + std::io::Seek>(writer: W, doc: &Document) -> Result<(), String> {
    ...
    let mut content_types = format!(r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="docpack/document.xml"/>
    ...
    let mut docx_rels = format!(r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
...
<w:hdr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"
  ...
  <w:p><w:r><w:t>{}</w:t></w:r></w:p>
    ...
    let mut document_xml = String::from(r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  <w:body>"#);
    ...
    for paragraph in &doc.paragraphs {
        if paragraph.is_heading() {
            ...
            let text = paragraph.runs.first().map(|r| escape_xml(&r.text)).unwrap_or_default();
